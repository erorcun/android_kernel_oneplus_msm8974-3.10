...
int msm_camera2_fill_vreg_params(struct camera_vreg_t *cam_vreg,
...
int msm_sensor2_get_sub_module_index(struct device_node *of_node,
...
int msm_sensor2_get_dt_actuator_data(struct device_node *of_node,
...
int msm_sensor2_get_dt_csi_data(struct device_node *of_node,
...
int msm_camera2_get_dt_power_setting_data(struct device_node *of_node,
...
int msm_camera2_get_dt_gpio_req_tbl(struct device_node *of_node,
...
int msm_camera2_get_dt_gpio_set_tbl(struct device_node *of_node,
	struct msm_camera_gpio_conf *gconf, uint16_t *gpio_array,
	uint16_t gpio_array_size)
{
	int rc = 0, i = 0;
...
int msm_camera2_init_gpio_pin_tbl(struct device_node *of_node,
	struct msm_camera_gpio_conf *gconf, uint16_t *gpio_array,
	uint16_t gpio_array_size)
{
	int rc = 0, val = 0;
...
int msm_camera2_get_dt_vreg_data(struct device_node *of_node,
	struct camera_vreg_t **cam_vreg, int *num_vreg)
{
	int rc = 0, i = 0;
	uint32_t count = 0;
...
static int msm_camera2_enable_i2c_mux(struct msm_camera_i2c_conf *i2c_conf)
{
...
static int msm_camera2_disable_i2c_mux(struct msm_camera_i2c_conf *i2c_conf)
{
	struct v4l2_subdev *i2c_mux_sd =
		dev_get_drvdata(&i2c_conf->mux_dev->dev);
	v4l2_subdev_call(i2c_mux_sd, core, ioctl,
...
int msm_camera2_power_up(struct msm_camera_power_ctrl_t *ctrl,
	...
	for (index = 0; index < ctrl->power_setting_size; index++) {
		...
		case SENSOR_I2C_MUX:
			if (ctrl->i2c_conf && ctrl->i2c_conf->use_i2c_mux)
				msm_camera2_enable_i2c_mux(ctrl->i2c_conf);
			break;
		default:
...
power_up_failed:
	...
	for (index--; index >= 0; index--) {
		...
		case SENSOR_I2C_MUX:
			if (ctrl->i2c_conf && ctrl->i2c_conf->use_i2c_mux)
				msm_camera2_disable_i2c_mux(ctrl->i2c_conf);
			break;
		default:
			pr_err("%s error power seq type %d\n", __func__,
				power_setting->seq_type);
...
int msm_camera2_power_down(struct msm_camera_power_ctrl_t *ctrl,
	enum msm_camera_device_type_t device_type,
	struct msm_camera_i2c_client *sensor_i2c_client)
{
	int index = 0;
